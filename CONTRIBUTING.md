...
Thank you for your interest in contributing to our project. Whether it's a
bug report, new feature, correction, or additional documentation, we greatly
...
2. Modify the source; please focus on the specific change you are
   contributing. If you also reformat all the code, it will be hard for us
   to focus on your change.
...
contribute on. Looking at any 'help wanted' issues is a great place to
start.
...
See the [LICENSE](LICENSE.txt) file for our project's licensing. We will ask you
