# AI CLI Session Guide

This file provides guidance to Claude Code when working in an AI CLI session on the AMMO Sessions Server.

## Communication Rules (all agents, including the orchestrator)

1. Speak in simple plain, concise English. Put simplicity first: prefer the simplest word and the shortest sentence that keeps the meaning.
2. Write technical documents in ASD-STE100 Simplified Technical English.
3. No preambles and no closing pleasantries.
