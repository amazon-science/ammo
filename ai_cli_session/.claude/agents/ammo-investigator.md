...
- `CALLER: ammo-impl-champion`: investigate activation, correctness, compile, batch-regression, weak-E2E, or suspicious sweep failures. Return `ROOT CAUSE IDENTIFIED` or `INCONCLUSIVE`.
