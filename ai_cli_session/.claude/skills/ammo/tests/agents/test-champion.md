...
- `references/debate-scoring-rubric.md` § Probability ceilings: "Anti-regression: proposed authoring technology is strictly higher in the abstraction ranking than the baseline's ... without Tier 2+ beats-baseline evidence" → P-score ceiling 3/10.
