...
SKILL.md's Stage 7 contract codifies the same rule from the orchestrator side, and the stop-gate hook enforces it mechanically — it blocks session end while `campaign.status == "active"`.
