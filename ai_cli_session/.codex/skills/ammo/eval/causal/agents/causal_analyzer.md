...
| `quoted_content` | yes | Verbatim excerpt from the cited lines, truncated to about 200 characters if long |

Open the artifact file, find the exact supporting lines, and include the verbatim text. The citation validator checks that cited files exist and that `quoted_content` matches the cited lines.
...
[
  {
    ...
    "evidence": [
      {
        "file_path": "debate/campaign_round_1/proposals/champion-3.md",
        "line_start": 42,
        "line_end": 42,
      ...
      },
      {
        ...
        "quoted_content": "| MoE dispatch | 14.8% | 312 us |"
      }
    ]
  }
]
